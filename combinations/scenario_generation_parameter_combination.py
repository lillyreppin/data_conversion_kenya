...
class Scenarios:
    def __init__(self, path_to_cost_input: str, path_to_base_input: str, path_to_lifetime_input: str):
    ...
    def scenario_generation(self, n_scenarios: int = []):
        ...
        for US_scenario in scenarios:
            ...
            for num in range(0, n_scenarios):
                ...
                # in Technodata.csv: randomise TechnicalLife according to TechnicalLife_random
                ...
                technodata_final2.to_csv(path_techno_data)
